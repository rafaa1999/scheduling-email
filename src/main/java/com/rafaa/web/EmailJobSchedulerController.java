...
import com.rafaa.job.EmailJob;
import com.rafaa.payload.ScheduleEmailRequest;
import com.rafaa.payload.ScheduleEmailResponse;
...
public class EmailJobSchedulerController {
   ...
   private Scheduler scheduler;
    ...
    public ResponseEntity<ScheduleEmailResponse> scheduleEmail(@Valid @RequestBody ScheduleEmailRequest scheduleEmailRequest) {
        try {
            ZonedDateTime dateTime = ZonedDateTime.of(scheduleEmailRequest.getLocalDate().atStartOfDay(), scheduleEmailRequest.getZoneId());
